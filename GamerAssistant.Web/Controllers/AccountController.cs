...
using GamerAssistant.Sessions;
using GamerAssistant.Web.Controllers.Results;
using GamerAssistant.Web.Models;
using GamerAssistant.Web.Models.Account;
...
{
    public class AccountController : GamerAssistantControllerBase
    {
